...
void main() {
  group('TokenParameters', () {
    ...
    test('public key is P-256K private key without d parameter', () {
      ...
      expect(tokenParameters.public, expetedPublicJWK);
    });
    ...
    test('did EBSI', () {
      ...
      final tokenParameters = TokenParameters(private);
      expect(tokenParameters.did, expectedDid);
    });
    ...
    test('kid EBSI', () {
      ...
      final tokenParameters = TokenParameters(private);
      expect(tokenParameters.kid, expetedKid);
    });

    test("algorithm of the key's curve", () {
      const expetedAlg = 'ES256K';
      final tokenParameters = TokenParameters(private);
      expect(tokenParameters.alg, expetedAlg);
    });

    test('thumbprint of the public Key', () {
      const expetedThumbprint = [
        173,
        150,
        139,
        1,
      ...
      final tokenParameters = TokenParameters(private);
      expect(tokenParameters.thumbprint(), expetedThumbprint);
    });
    ...
    test('thumbrprint of the Key from exemple in rfc 7638', () {
      ...
      expect(tokenParameters.thumbprint(), expectedThumbprint);
    });
  });
}
