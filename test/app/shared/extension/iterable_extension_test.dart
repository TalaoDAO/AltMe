...
void main() {
  group('IterableExtension', () {
    test(
      'firstWhereOrNull returns first element that satisfies the condition',
      () {
    ...
    test(
      'firstWhereOrNull returns null if no element satisfies the condition',
      () {
    ...
    test(
      'lastWhereOrNull returns last element that satisfies the condition',
      () {
        final list = [1, 2, 3, 4, 5];
    ...
    test(
      'lastWhereOrNull returns null if no element satisfies the condition',
      () {
        final list = [1, 3, 5, 7, 9];
