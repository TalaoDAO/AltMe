...
void main() {
  group('Uint8ListExtension', () {
    test('filterPayload returns the original list '
    ...
    test('filterPayload returns the original list '
      ...
      final differentFirstElement = Uint8List.fromList([
        6,
        1,
        3,
        4,
      ...
      final differentSecondElement = Uint8List.fromList([
        5,
        5,
        3,
        4,
    ...
    test('filterPayload returns a sublist starting from index 6 '
