...
void main() {
  ...
  setUp(() {
    ...
    when(
      () => mockEnterpriseCubit.getWalletProviderAccount(any()),
    ).thenAnswer((_) async {});

    whenListen(profileCubit, Stream.fromIterable([profileCubit.state]));
  });
  ...
  group('Wallet Ready Page Test', () {
          ...
          child: Builder(
            builder: (context) => Scaffold(
              floatingActionButton: FloatingActionButton(
                onPressed: () {
                  Navigator.of(context).push<void>(WalletReadyPage.route());
                },
              ),
            ),
          ),
    ...
    testWidgets('renders WalletReadyView', (tester) async {
      await tester.pumpApp(
        MultiBlocProvider(
          providers: [
            BlocProvider<WalletReadyCubit>.value(value: walletReadyCubit),
    ...
    testWidgets('navigatest to dashboardPage when text "start " is'
    ...
    testWidgets(
      'navigatest to dashboardPage when MyElevatedButton is pressed',
      (tester) async {
        await tester.pumpApp(
          MockNavigatorProvider(
            navigator: navigator,
