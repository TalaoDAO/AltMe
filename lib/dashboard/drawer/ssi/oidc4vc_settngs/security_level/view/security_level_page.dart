...
class SecurityLevelPage extends StatelessWidget {
  const SecurityLevelPage({super.key});

  static Route<dynamic> route() {
    return MaterialPageRoute<void>(
      builder: (_) => const SecurityLevelPage(),
      settings: const RouteSettings(name: '/SecurityLevelPage'),
    );
  }
